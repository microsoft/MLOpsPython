...
class Env(Singleton):
    ...
    def __init__(self):
        ...
        self._execute_pipeline = os.environ.get("EXECUTE_PIPELINE")
        ...
        self._target_path = os.environ.get("TARGET_PATH")
        self._data_reference_name = os.environ.get("DATA_REFERENCE_NAME")
        self._path_on_datastore = os.environ.get("PATH_ON_DATASTORE")
        self._data_name = os.environ.get("DATA_NAME")        
        self._train_dataset_name = os.environ.get("TRAIN_DATASET_NAME")        
        self._test_dataset_name = os.environ.get("TEST_DATASET_NAME")        
